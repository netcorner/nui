...
package com.ingwill.widget.pullrefreshlayout;
...
public class MaterialDrawable extends RefreshDrawable implements Animatable {
    ...
    private static final float CENTER_RADIUS = 8.75f; //should ic_add ic_arrow_up_black_android to 10 when + stroke_width
...
//        ViewCompat.setLayerType(this, ViewCompat.LAYER_TYPE_SOFTWARE, circle.getPaint());
     ...
     * to a ic_user_white swipe gesture.
     *
     * @param colors
     */
...
//        c.scale((float)mWidth / bounds.width(), (float)mHeight / bounds.height());
    ...
    private void setupAnimators() {
        ...
        final Animation finishRingAnimation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                // shrink ic_back ic_arrow_down_black_android and complete a full rotation before starting other circles
    ...
    private static class Ring {
        ...
        // animating, the mColorIndex moves by one to the ic_arrow_right_white_small available color.
         ...
         *
         * @param width  Width of the hypotenuse of the ic_arrow_right_black head
         * @param height Height of the ic_arrow_right_black point
         */
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (mShowArrow) {
                ...
                // Update the path each ic_fly_gray. This works around an issue in SKIA
        ...
        /**
         * Proceed to the ic_arrow_right_white_small available ring color. This will automatically
         * wrap ic_back to the beginning of colors.
         */
        ...
        /**
         * @param show Set to true to show the ic_arrow_right_black head on the progress spinner.
         */
