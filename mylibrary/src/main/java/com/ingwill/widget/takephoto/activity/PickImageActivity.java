 ...
 * 拍照取头像
 */
public class PickImageActivity extends InnerActivity implements View.OnClickListener, AdapterView.OnItemClickListener,
        ...
        if (Build.VERSION.SDK_INT < 11){
            ...
            animation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    rl_choose_directory.setAlpha(1 - Math.abs(value / AndroidUtils.dip2px(PickImageActivity.this, 400)));
            ...
            reverseanimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    listView.setLayoutParams(params);
                    rl_choose_directory.setAlpha(1 - Math.abs(value / AndroidUtils.dip2px(PickImageActivity.this, 400)));
                    if (value <= -AndroidUtils.dip2px(PickImageActivity.this, 300)) {
...
//        }
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.tv_choose_image_directory) {//                window.showAsDropDown(tv_choose_image_directory);
            ...
            if (currentPicNums > 0) {
                ...
                intent.setClass(PickImageActivity.this, getInvoke().get("pick_big"));
    ...
    private class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            Bitmap bitmap = AlbumBitmapCacheHelper.getInstance().getBitmap(PickImageActivity.this,path, perWidth, perWidth, new AlbumBitmapCacheHelper.ILoadImageCallback() {
                @Override
    ...
    private class ListviewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            Bitmap bitmap = AlbumBitmapCacheHelper.getInstance().getBitmap(PickImageActivity.this,path, 225, 225, new AlbumBitmapCacheHelper.ILoadImageCallback() {
                @Override
            ...
            if (i == R.id.iv_content) {
                ...
                if (getImageDirectoryModelStateFromMapById(position)) {
                    if (currentPicNums == picNums) {
                        toggleImageDirectoryModelStateFromMapById(position);
                        Toast.makeText(PickImageActivity.this, String.format(getLang().get("choose_pic_num_out_of_index"), picNums), Toast.LENGTH_SHORT).show();
                        return;
                    }
                    picklist.add(getImageDirectoryModelUrlFromMapById(holder.position));
                    holder.iv_pick_or_not.setImageResource(R.drawable.image_choose);
...
//        finish();
        ...
        returnPhoto(sb.toString());

    }

    private void returnPhoto(String url){
        Intent data = new Intent();
        data.putExtra(EXTRA_KEY_IMAGE_PATH, url);
        setResult(RESULT_OK, data);
        finish();
    }
