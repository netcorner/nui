...
import com.ingwill.widget.clip.ClipLayout;
 ...
 * 剪切头像
 */
public class ClipActivity extends InnerActivity {
    ...
    public int getLayoutId() {
        return R.layout.clip_activity_choosephoto;
    }
    ...
    private void clipBitmap() {
        ...
        File file= BitmapUtil.saveBmpToSd(bitmap,fp,60);
