 ...
 * 查看大图或者选择大图
 */
public class PickBigImagesActivity extends InnerActivity implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    public int getLayoutId() {
        return R.layout.takephoto_activity_pick_big_images;
    }
...
//        headStatusColor=getIntent().getIntExtra(PickOrTakeImageActivity.STATUS_COLOR,0);
...
//        }
//
//        titleColor=getIntent().getIntExtra(PickOrTakeImageActivity.TITLE_COLOR,0);
//        if(titleColor!=0){
...
//        });
    ...
    protected void initData() {
        allimages = PickOrTakeImageActivity.activity.getAllImagesFromCurrentDirectory();    //(ArrayList<SingleImageModel>) getIntent().getSerializableExtra(EXTRA_DATA);
    ...
    private class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = LayoutInflater.from(PickBigImagesActivity.this).inflate(R.layout.takephoto_zoom_image, null);
            ...
            Bitmap bitmap = AlbumBitmapCacheHelper.getInstance().getBitmap(PickBigImagesActivity.this,getPathFromList(position), 0, 0, new AlbumBitmapCacheHelper.ILoadImageCallback() {
                @Override
                public void onLoadImageCallBack(Bitmap bitmap, String path, Object... objects) {
                    ...
                    if (view != null && bitmap != null)
                        ((ZoomImageView)viewPager.findViewWithTag(path)).setSourceImageBitmap(PickBigImagesActivity.this,bitmap, PickBigImagesActivity.this);
                }
            }, position);
            if (bitmap != null){
                zoomImageView.setSourceImageBitmap(PickBigImagesActivity.this,bitmap, PickBigImagesActivity.this);
            }
