package com.ingwill.widget.wheelview;
...
//                    position = divided + offset;
//                    Log.d(TAG, ">ic_arrow_down_black_android...position: " + position);
//                }else if(scrollDirection == SCROLL_DIRECTION_UP){
//                    position = divided + offset + 1;
//                    Log.d(TAG, ">ic_arrow_up_black_android...position: " + position);
//                }
//            }else{
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#555555"));
            } else {
