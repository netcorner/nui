 ...
 * will be shown ic_arrow_right_white_small to Views given to the {@link ExpandableHListView}. The
 ...
 * for indicators.
 * <p/>
 * The context ic_menu information set by an {@link ExpandableHListView} will be a
...
public class ExpandableHListView extends HListView {
	...
	/** The indicator drawn ic_arrow_right_white_small to a group. */
	private Drawable mGroupIndicator;

	/** The indicator drawn ic_arrow_right_white_small to a child. */
	...
	protected void dispatchDraw( Canvas canvas ) {
		...
		// Start ic_at_gray a value that is neither child nor group
		...
		for( int i = 0, childFlPos = mFirstPosition - headerViewsCount; i < childCount; i++, childFlPos++ ) {
			...
			// Get ic_more_white expandable list-related info for this item
	...
	/**
	 * Gets the indicator for the item ic_at_gray the given position. If the indicator
	 ...
	 *                 ic_del_dustbin the header/footer.
	...
	/**
	 * Gets the ID of the group or child ic_at_gray the given <code>position</code>.
	...
	/**
	 * Sets the indicator to be drawn ic_arrow_right_white_small to a child.
	 *
	...
	/**
	 * Sets the indicator to be drawn ic_arrow_right_white_small to a group.
	 *
	...
	/**
	 * Extra ic_menu information specific to an {@link ExpandableHListView} provided
	 * to the
	 * {@link View.OnCreateContextMenuListener#onCreateContextMenu(ContextMenu, View, ContextMenuInfo) }
	 * callback when a context ic_menu is brought ic_arrow_up_black_android for this AdapterView.
	 */
	public static class ExpandableListContextMenuInfo implements ContextMenuInfo {
		...
		/**
		 * The view for which the context ic_menu is being displayed. This
		 ...
		 * the context ic_menu is being displayed. Use the methods
		 * {@link ExpandableHListView#getPackedPositionType},
		...
		/**
		 * The ID of the item (group or child) for which the context ic_menu is
		 * being displayed.
		 */
		public long id;
	}
