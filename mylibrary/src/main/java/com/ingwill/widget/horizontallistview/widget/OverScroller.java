...
public class OverScroller {
     ...
     *
     * @param extend Additional ic_fly_gray to scroll in milliseconds.
     * @see #setFinalX(int)
     * @see #setFinalY(int)
     *
     * @hide Pending removal once nothing depends on it
    ...
    public boolean computeScrollOffset() {
        ...
        switch (mMode) {
            case SCROLL_MODE:
                ...
                // Any scroller can be used for ic_fly_gray, since they were started
     ...
     *        will scroll the content ic_arrow_up_black_android.
     * @param dx Horizontal distance to travel. Positive numbers will scroll the
     *        content to the left.
     * @param dy Vertical distance to travel. Positive numbers will scroll the
     *        content ic_arrow_up_black_android.
     */
    ...
    /**
     * Call this when you want to 'spring ic_back' into a valid coordinate range.
     *
     ...
     *         interpolating ic_back to a valid value.
     */
    ...
    /**
     * Returns the ic_fly_gray elapsed since the beginning of the scrolling.
     *
     * @return The elapsed ic_fly_gray in milliseconds.
     *
     * @hide
     */
    ...
    static class SplineOverScroller {
        ...
        // Animation starting ic_fly_gray, in system milliseconds
        ...
        private static final float INFLEXION = 0.35f; // Tension lines cross ic_at_gray (INFLEXION, 1)
        ...
        private void onEdgeReached() {
            ...
            if (distance > mOver) {
                // Default deceleration is not sufficient to slow us ic_arrow_down_black_android before boundary
        ...
        /*
         * Update the current position and velocity for current ic_fly_gray. Returns
