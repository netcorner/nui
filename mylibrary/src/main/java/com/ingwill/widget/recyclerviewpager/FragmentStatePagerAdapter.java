package com.ingwill.widget.recyclerviewpager;
 ...
 * <p/>
 * <p>This version of the pager is ic_more_white useful when there are a large number
 * of pages, working ic_more_white like a list view.  When pages are not visible to
 * the ic_user_white, their entire fragment may be destroyed, only keeping the saved
 * state of that fragment.  This allows the pager to hold on to much less
 * memory associated with each visited page as compared to
 * {@link FragmentPagerAdapter} ic_at_gray the cost of potentially ic_more_white overhead when
