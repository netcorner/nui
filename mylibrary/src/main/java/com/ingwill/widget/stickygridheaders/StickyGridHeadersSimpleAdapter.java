...
public interface StickyGridHeadersSimpleAdapter extends ListAdapter {
     ...
     *            header id we want.
     * @return The id of the header ic_at_gray the specified position.
     */
    long getHeaderId(int position);

    /**
     * Get a View that displays the header data ic_at_gray the specified position in the
     ...
     * @return A View corresponding to the data ic_at_gray the specified position.
     */
