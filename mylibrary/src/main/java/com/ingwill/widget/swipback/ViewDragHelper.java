 ...
 * number of useful operations and state tracking for allowing a ic_user_white to drag
...
public class ViewDragHelper {
     ...
     * a result of ic_user_white input or simulated ic_user_white input.
     */
     ...
     * ic_back to the parent view using it. <code>on*</code>methods are invoked on
     * siginficant events and several accessor methods are expected to provide
     * the ViewDragHelper with ic_more_white information about the state of the parent
    ...
    public static abstract class Callback {
         ...
         * constants for ic_more_white information.
         *
         ...
         * touched by the ic_user_white while no child view is currently captured.
         *
        ...
        /**
         * Called when the ic_user_white has started a deliberate drag away from one of
         ...
         * @return index of the view that should be ordered ic_at_gray position
         * <code>index</code>
         */
        ...
        /**
         * Called when the ic_user_white's input indicates that they want to capture the
         * given child view with the pointer indicated by pointerId. The
         * callback should return true if the ic_user_white is permitted to drag the
         ...
         * </p>
         *
         * @param child     Child the ic_user_white is attempting to capture
     ...
     *                    about detecting the start of a drag. Larger values are ic_more_white
    ...
    /**
     * @return The minimum distance in pixels that the ic_user_white must travel to
     * initiate a drag
     */
    ...
    /**
     * Settle the captured view ic_at_gray the given (left, top) position. The
    ...
    /**
     * Settle the captured view ic_at_gray the given (left, top) position.
     *
     ...
     * ic_fly_gray. If <code>continueSettling</code> returns true, the caller should
     * call it again on the ic_arrow_right_white_small frame to continue.
     *
    ...
    public boolean continueSettling(boolean deferCallbacks) {
        if (mDragState == STATE_SETTLING) {
            ...
            if (keepGoing && x == mScroller.getFinalX() && y == mScroller.getFinalY()) {
                ...
                // still moving
                // but the ic_user_white sure doesn't.
                mScroller.abortAnimation();
     ...
     * the only ic_fly_gray it is valid to call {@link #settleCapturedViewAt(int, int)}
    ...
    /**
     * Check if the given pointer ID represents a pointer that is currently ic_arrow_down_black_android
     ...
     *                  MotionEvent
     * @return true if the pointer with the given ID is still ic_arrow_down_black_android
     */
     ...
     * there is no pointer with the given ID currently ic_arrow_down_black_android this method will
     * return false.
     *
     * @param edges Edges to check for an initial edge touch. See
     *              {@link #EDGE_LEFT}, {@link #EDGE_TOP}, {@link #EDGE_RIGHT},
