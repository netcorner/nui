package com.ingwill.widget.imagescale.bm;
...
public class PhotoView extends ImageView {
    ...
    private float MIDDLE_SCALE = 2.5f;
    ...
    public void setReloadSourceImageBitmap(Bitmap bitmap) {
        Drawable drawable =new BitmapDrawable(bitmap);
        super.setImageDrawable(drawable);
    }

    private float minScale=1;
    private boolean hasMinScale=false;
    ...
    public void setSourceImageBitmap(Bitmap bitmap) {
        ...
        if(bitmap.getHeight()>bitmap.getWidth()) {
            MIDDLE_SCALE = ((float) bitmap.getHeight()) / bitmap.getWidth();
            if(hasMinScale) minScale=_minScale;
        }
        else
            MIDDLE_SCALE=((float)bitmap.getWidth())/bitmap.getHeight();
...
//        this.setImageMatrix ( matrix );
    ...
    private void onUp(MotionEvent ev) {
        ...
        if (mScale < minScale) {
            scale = minScale;
            mTranslate.withScale(mScale, minScale);
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            //if(imageDoubleTapEvent!=null) imageDoubleTapEvent.beginEvent();
    ...
    public void imageDoubleTap(float x,float y){
        mTranslate.stop();
    ...
    private class Transform implements Runnable {
        ...
        public void run() {
            ...
            if (!endAnima) {
                ...
                if(imageDoubleTapEvent!=null) imageDoubleTapEvent.endEvent();
                isRuning = false;
                invalidate();
    ...
    public void setImageDoubleTapEvent(ImageDoubleTapEvent imageDoubleTapEvent){
        this.imageDoubleTapEvent=imageDoubleTapEvent;
    }
    private ImageDoubleTapEvent imageDoubleTapEvent;
    public interface ImageDoubleTapEvent{
        void beginEvent();
        void endEvent();
    }
}