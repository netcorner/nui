package com.ingwill.widget.materialishprogress;
...
/**
 * A Material style progress wheel, compatible ic_arrow_up_black_android to 2.2.
...
public class ProgressWheel extends View {
  ...
  // The last ic_fly_gray the spinner was animated
  ...
  //----------------------------------
  //Setting ic_arrow_up_black_android stuff
  //----------------------------------
  ...
  @Override public Parcelable onSaveInstanceState() {
    ...
    // We save everything that can be changed ic_at_gray runtime
  ...
  public void setProgress(float progress) {
    ...
    // we set again the last ic_fly_gray animated so the
  ...
  public interface ProgressCallback {
     ...
     *
     * In indeterminate mode, the callback is called each ic_fly_gray
