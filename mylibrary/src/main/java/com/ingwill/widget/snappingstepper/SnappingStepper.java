package com.ingwill.widget.snappingstepper;
...
import com.ingwill.widget.snappingstepper.listener.SnappingStepperValueChangeListener;
...
public class SnappingStepper extends RelativeLayout implements View.OnTouchListener, ValueAnimator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
    ...
    private void initViews(AttributeSet attrs) {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.widget_snappingstepper, this, true);
