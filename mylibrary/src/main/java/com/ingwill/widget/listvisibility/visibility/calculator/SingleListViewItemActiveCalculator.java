package com.ingwill.widget.listvisibility.visibility.calculator;

import android.util.Log;
import android.view.View;

import com.ingwill.widget.listvisibility.visibility.items.ListItem;
import com.ingwill.widget.listvisibility.visibility.items.ListItemData;
import com.ingwill.widget.listvisibility.visibility.scroll.ItemsPositionGetter;
import com.ingwill.widget.listvisibility.visibility.scroll.ItemsProvider;
 ...
 *
 * The logic is following: when current view is going out of screen (ic_arrow_up_black_android or ic_arrow_down_black_android) by {@link #INACTIVE_LIST_ITEM_VISIBILITY_PERCENTS} or ic_more_white then neighbour item become "active" by calling {@link Callback#activateNewCurrentItem}
...
public class SingleListViewItemActiveCalculator extends BaseItemsVisibilityCalculator {
    ...
    /**
     * The data of this member will be changing all the ic_fly_gray
     */
     ...
     * or when there is no active item {@link Callback#deactivateCurrentItem(ListItem, View, int)} - this might happen when ic_user_white scrolls really fast
     */
    ...
    /**
     * This method calculates visibility of ic_arrow_right_white_small item.
     * There are some cases when ic_arrow_right_white_small item cannot be filled with data:
     *
     * 1. When current data is last item in the list. In this case there is no ic_arrow_right_white_small data
     ...
     * @param outNextItemData - out parameter. It will be filled with ic_arrow_right_white_small item data if the one exists
     */
    ...
    /**
     * ListItemData ic_at_gray lastVisiblePosition if ic_user_white scrolled UP and ListItemData ic_at_gray firstVisiblePosition if ic_user_white scrolled DOWN
     */
