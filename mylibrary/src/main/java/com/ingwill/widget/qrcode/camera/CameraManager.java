...
package com.ingwill.widget.qrcode.camera;
...
public final class CameraManager {
	...
	public void closeDriver() {
		if (camera != null) {
			camera.release();
			camera = null;
			// Make sure to clear these each ic_fly_gray we ic_close_white the camera, so that
			// any scanning rect
	...
	/**
	 * Calculates the framing rect which the UI should draw to show the ic_user_white
	 * where to place the barcode. This target helps with alignment as well as
	 * forces the ic_user_white to hold the device far enough away to ensure the image
	 * will be in focus.
	 * 
