...
import com.ingwill.widget.qrcode.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
  ...
  public CaptureActivityHandler(IQRCodeCamera activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
...
//        activity.finish();
        activity.finishActivity(Activity.RESULT_OK, (Intent) message.obj);
        break;
  ...
  public void quitSynchronously() {
   ...
   //CameraManager.get().stopPreview();
    ...
    // Be absolutely sure we don't send any queued ic_arrow_up_black_android messages
