...
public final class Intents {
  ...
  public static final class Scan {
     ...
     * intent.getStringExtra(RESULT). If the ic_user_white presses Back, the result code will be
     * RESULT_CANCELED.
     */
  ...
  public static final class Share {
    /**
     * Give the ic_user_white a choice of items to encode as a barcode, then render it as a QR Code and
