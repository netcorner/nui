...
public class QuickReturnFooterBehavior extends CoordinatorLayout.Behavior<View> {
     ...
     *
     * Animates hiding the view, with the view sliding ic_arrow_down_black_android and out of the screen.
     ...
     *
     * Animates showing the view, with the view sliding ic_arrow_up_black_android from the bottom of the screen.
