package com.ingwill.widget.dragview;
...
import com.ingwill.widget.dragview.interfaces.DraggableListener;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                Log.i(TAG, "onInterceptTouchEvent ic_arrow_down_black_android");
                mLastMotionX = x;
                mLastMotionY = y;
...
//                Log.e(TAG, "onInterceptTouchEvent ic_arrow_up_black_android or cancel");
...
//
                    ...
                    if (velocityX > SNAP_VELOCITY) {
                        ...
                        Log.e(TAG, "ic_close_white to right，velocityX：" + velocityX);
                        snapToScreen(currentScreen - 1);

                    }
                    //快速向左滑屏
                    else if (velocityX < -SNAP_VELOCITY) {
                        Log.e(TAG, "ic_close_white to left，velocityX：" + velocityX);
                        snapToScreen(currentScreen + 1);
                    }
                    //缓慢滑动
                    else {
