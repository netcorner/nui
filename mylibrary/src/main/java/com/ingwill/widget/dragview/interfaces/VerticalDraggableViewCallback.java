...
import com.ingwill.widget.dragview.VerticalDraggableView;
...
public class VerticalDraggableViewCallback extends ViewDragHelper.Callback {
    ...
    public VerticalDraggableViewCallback(VerticalDraggableView verticalDraggableView) {
        ...
        Y_MIN_DISTANCE = DisplayMetricsUtils.getScreenHeightPixels((Activity) verticalDraggableView.getContext())/10;
    }
