package com.ingwill.widget.dragview.interfaces;
...
import com.ingwill.widget.dragview.DraggableView;
import com.ingwill.widget.dragview.utils.DisplayMetricsUtils;
...
public class DraggableViewCallback extends ViewDragHelper.Callback {
    ...
    public DraggableViewCallback(DraggableView draggableView) {
        ...
        X_MIN_DISTANCE = DisplayMetricsUtils.getScreenWidthPixels((Activity) draggableView.getContext())/10;
        Y_MIN_DISTANCE = DisplayMetricsUtils.getScreenHeightPixels((Activity) draggableView.getContext())/10;
    }
     ...
     *
     * @param view      child the ic_user_white is attempting to capture.
